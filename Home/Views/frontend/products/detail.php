...
<body>
            ...
            <div class="container">
                <div class="col-md-12 single-right">
                    <div class="col-md-5 single-right-left animated wow slideInUp" data-wow-delay=".5s">
                        <img style='width:272px' id='img_01' src='<?= $thumbnail ?>'
                    ...
                    <div class="col-md-7 single-right-left simpleCart_shelfItem animated wow slideInRight"
                        ...
                        <div class="occasion-cart mt-5">
                            <a style="cursor:pointer" data-id="<?= $product["id"] ?>" class="item_add">Thêm vào giỏ
                                hàng</a>
                        </div>
                        <div class="social">
                        ...
                        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                            <ul id="myTab" class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="" id="home-tab" role="tab"
                                        data-toggle="tab" aria-controls="home" aria-expanded="true">Mô tả sản phẩm</a>
                                </li>
    ...
    <div class="new-collections">
        <div class='container'>
            ...
            <nav style="margin:10px" aria-label="...">
                <ul class="pagination ml-2">
                    <?php echo $pageTotal; for ($i = 1; $i <= $pageTotal; $i++): ?>
        ...
        $('a.item_add').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var alert_danger = `<div class='alert alert-danger' id='success-alert'>
                                            <strong>Sản phẩm đã có trong giỏ hàng</strong>
                                        </div>`;
