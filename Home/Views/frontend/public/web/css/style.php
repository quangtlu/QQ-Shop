...
ul.social-icons li a.facebook{
	background: url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -2px -5px;
    display: block;
    width: 20px;
    height: 20px;
}
ul.social-icons li a.facebook:hover{
	background: url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -2px -54px;
    display: block;
}
ul.social-icons li a.twitter{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -49px -13px;
    display: block;
    width: 20px;
    height: 20px;
}
ul.social-icons li a.twitter:hover{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -49px -54px;
    display: block;
}
ul.social-icons li a.g{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -94px -12px;
    display: block;
    width: 20px;
    height: 20px;
}
ul.social-icons li a.g:hover{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -94px -54px;
    display: block;
}
ul.social-icons li a.instagram{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -139px -12px;
    display: block;
    width: 20px;
    height: 20px;
}
ul.social-icons li a.instagram:hover{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -139px -52px;
    display: block;
}
.logo-nav-left{
	float:left;
...
.sb-search-submit {
	background:#fff url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat 7px -91px;
...
/*-- banner --*/
.banner{
	background:url(./Home/Views/frontend/public/web/images/banner.jpg) no-repeat 0px 0px;
...
.new-collections h3:before,.new-collections h3:after,h3.title:before,h3.title:after,.mail h3:before,.mail h3:after,.single-related-products h3:before,.single-related-products h3:after{
	position: absolute;
    top: 50%;
    width: 15%;
    height: 1px;
...
.collections-bottom-grids{
	background:url(./Home/Views/frontend/public/web/images/12.jpg) no-repeat 0px 0px;
	background-size:cover;
	-webkit-background-size:cover;
	-moz-background-size:cover;
	-o-background-size:cover;
...
.categories ul li{
	...
	color:#999;
	font-size:14px;
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat -9px -150px;
	padding-left:2em;
	margin-bottom:1em;
}
.categories ul li a{
...
.starRating:not(old) > label {
    float: right;
    background: url(./Home/Views/frontend/public/web/images/1.png);
...
.starRating:not(old) > label:before{
  ...
  width           : 18px;
  height          : 18px;
  background      : url(./Home/Views/frontend/public/web/images/2.png);
  background-size : contain;
  opacity         : 0;
...
.login-form-grids input[type="email"]{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat 5px -182px #fff;
}
.login-form-grids input[type="password"]{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat 5px -220px #fff;
	margin:1em 0 0;
}
.forgot {
    margin: 1.5em 0 0;
...
.login-form-grids input[type="text"]{
	background:url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat 5px -259px #fff;
}
...
@media (max-width:1080px){
	...
	.new-collections h3, h3.title, .mail h3, .single-related-products h3 {
		font-size: 2.6em;
	}
...
@media (max-width:991px){
	...
	.sb-icon-search,.sb-search.sb-search-open .sb-icon-search, .no-js .sb-search .sb-icon-search,.sb-search-submit {
		background: #fff url(./Home/Views/frontend/public/web/images/img-sp.png) no-repeat 0px -101px;
	}
	.sb-search {
		min-width: 35px;
		height: 35px;
...
@media (max-width: 414px){
	...
	.collections-bottom-grids {
		background: url(./Home/Views/frontend/public/web/images/12.jpg) no-repeat -120px 0px;
		background-size: cover;
		-webkit-background-size: cover;
		-moz-background-size: cover;
		-o-background-size: cover;
...
@media (max-width: 320px){
	...
	.collections-bottom-grids {
		background: url(./Home/Views/frontend/public/web/images/12.jpg) no-repeat -80px 0px;
		background-size: cover;
		-webkit-background-size: cover;
		-moz-background-size: cover;
		-o-background-size: cover;
