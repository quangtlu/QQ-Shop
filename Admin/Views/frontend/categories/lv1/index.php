...
<button type="button" class="mt-2 btn-sm btn createBtn btn-success">Thêm mới</button>
...
<div class="modal-layout">
    <div class="main-layout container col-md-6">
        <i class="fas fa-times close-btn"></i>
        <form method="POST" action="./index.php?controller=categorylv1&action=store" class="needs-validation mt-5" novalidate>
            <div class="form-row">
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            url		: './index.php?controller=categorylv1&action=LoadContent',
            dataType: 'html',
