...
<head>
    ...
    <title>Sửa danh mục cấp 2</title>
    <?php $this->view('frontend.public.base')?>
</head>

<body>
    <?php $this->view('frontend.public.header')?>
    <a href="./index.php?controller=categorylv2">
...
?>
        ...
        <form method="POST" action="./index.php?controller=categorylv2&action=update&id=<?php echo $category["id"] ?>" class="needs-validation mt-5" novalidate>
            <div class="form-row">
