        ...
        <div class="sidebar-start">
            <div class="sidebar-head">
                <a href="./index.php?controller=home" class="logo-wrapper" title="Home">
                    ...
                    <div class="logo-text">
                        ...
                        <span class="logo-subtitle">Quản trị QQ SHOP</span>
                    </div>
                </a>
            ...
            <div class="sidebar-body">
                <ul class="sidebar-body-menu">
                    <li>
                        <a class="" href="./index.php?controller=home"><i class="sidebar-icon fas fa-home"></i>Trang chủ</a>
                    </li>
                    <li>
                        <a class="show-cat-btn" href="##">
                            <i class="sidebar-icon fas fa-users"></i></span>Quản lý tài khoản
                        ...
                        <ul class="cat-sub-menu">
                            <li>
                                <a class="" href="./index.php?controller=user">
                                    <i class="sidebar-icon fas fa-user"></i>Tài khoản
                                </a>
                            </li>
                            <li>
                                <a class="" href="./index.php?controller=role">
                                    <i class="sidebar-icon fas fa-user-shield"></i></span>Nhóm quyền
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                <ul class="sidebar-body-menu">
                    <li>
                        <a class="show-cat-btn" href="##">
                        <i class="sidebar-icon fas fa-th-list"></i>Quản ý danh mục
                            <span class="category__btn transparent-btn" title="Open list">
                                <span class="sr-only">Open list</span>
                                <span class="icon arrow-down" aria-hidden="true"></span>
                            </span>
                        ...
                        <ul class="cat-sub-menu">
                            <li>
                                <a class="" href="./index.php?controller=categorylv1">
                                    <i class="sidebar-icon fas fa-file-alt"></i></i></i>Danh mục cấp 1
                                </a>
                            </li>
                            <li>
                                <a class="" href="./index.php?controller=categorylv2">
                                    <i class="sidebar-icon fas fa-file-alt"></i></i></span>Danh mục cấp 2
                                </a>
                            </li>
                            <li>
                                <a class="" href="./index.php?controller=categorylv3">
                                    <i class="sidebar-icon fas fa-file-alt"></i></i></span>Danh mục cấp 3
                                </a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="sidebar-footer">
            <a href="../" class="sidebar-user">
                <div class="sidebar-user-info">
                    ...
                    <span class="sidebar-user__subtitle">QQ Shop</span>
                </div>
            </a>
        </div>
    </aside>
                    ...
                    <div class="nav-user-wrapper">
                        <button href="##" class="nav-user-btn dropdown-btn" title="My profile" type="button">
                            ...
                            <span class="nav-user-img">
                                <picture>
                                    <source srcset="./Views/frontend/public/template/img/avatar/avatar-illustrated-02.webp" type="image/webp"><img
                                        src="./Views/frontend/public/template/img/avatar/avatar-illustrated-02.png" alt="User name">
                                </picture>
                            </span>
                        </button>
